...
describe("search", function () {
    ...
    it("search", async function () {
        ...
        const [items, count] = await search("dummy_token", ["foo"], ["bar"], ["baz"], ["user"], "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==");
